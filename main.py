...
testlist=FileToStudent(testlist)
sectionlist=FileToStudent(sectionlist)
lecturerlist=FileToStudent(lecturerlist)
mangerlist=FileToStudent(mangerlist)
victor=Manger("victor","m","123","0522573308","1")
mangerlist.append(victor)
liron=lecturer("liron", "s", '1234', '2222', '2')
studentlist.append(liron)
f = open('test1' + '.pdf')
